// ===== VERSION MARKER: V52-CONTACT-PAGE =====
export default {
...
const I18N = {
  "zh-Hant": {
    ...
    "lit_all": "全部", "news_source": "來源", "news_no_data": "目前沒有資料"
  },
  "zh-Hans": {
    ...
    "lit_all": "全部", "news_source": "来源", "news_no_data": "目前没有数据"
  },
  "en": {
    ...
    "lit_all": "All", "news_source": "Source", "news_no_data": "No data available"
  },
  "fr": {
    ...
    "lit_all": "Tous", "news_source": "Source", "news_no_data": "Aucune donnée disponible"
  },
  "de": {
    ...
    "lit_all": "Alle", "news_source": "Quelle", "news_no_data": "Keine Daten verfügbar"
  },
  "ja": {
    ...
    "lit_all": "すべて", "news_source": "出典", "news_no_data": "データがありません"
  },
  "eo": {
    ...
    "lit_all": "Ĉiuj", "news_source": "Fonto", "news_no_data": "Neniuj datumoj disponeblaj"
  },
  "es": {
    ...
    "lit_all": "Todos", "news_source": "Fuente", "news_no_data": "No hay datos disponibles"
  }
};
...
<style>
  ...
  .author-avatar { width: 120px; height: 120px; border-radius: 50%; object-fit: cover; background: #eee; }
...
async function renderNewsItem(url, env, lang, request) {
  ...
  const displaySummary = await getOrTranslate(env, "news", row.id, lang, "summary", row.summary || "");
...
async function renderSitemap(env) {
  ...
  // 靜態頁面
  const staticPaths = ["/", "/news", "/literature", "/media", "/tools", "/guide", "/about", "/author/shengyan", "/editorial-policy", "/privacy-policy", "/contact"];
  ...
  // 小工具頁面
  const toolSlugs = [
    "life/unit-converter", "office/bookmark-cleaner", "office/url-shortener",
